...
<head>
    ...
    <title>NetMouse NetSimulation</title>
...
<body>
    ...
    <div class="network" id="network">
        ...
        <div id="devicesContainer" class="devices-container">
            ...
            <br>
            <input type="number" id="lineWidth" min="1" value="5">
        ...
        <div class="add-device">
            ...
            <button id="addRouterBtn" class="add-device-btn" data-device-type="router"><i class="fas fa-network-wired"></i> Router</button>
            <button id="addSwitchBtn" class="add-device-btn" data-device-type="switch"><i class="fas fa-exchange-alt"></i> Switch</button>
            <button id="addhub"><i class="fas fa-exchange-alt"></i> Hub</button>
            <button id="addmulti"><i class="fas fa-exchange-alt"></i> Multi Switch</button>
            <button id="addPCBtn" class="add-device-btn" data-device-type="pc"><i class="fas fa-desktop"></i> PC</button>
            <button id="addLaptopBtn" class="add-device-btn" data-device-type="laptop"><i class="fas fa-laptop"></i> Laptop</button>
            <button id="addAccessPointBtn" class="add-device-btn" data-device-type="access-point"><i class="fas fa-wifi"></i> Access Point</button>
            <button id="addserver"><i class="fas fa-server"></i> Server</button>
            <button id="addfileserver"><i class="fas fa-server"></i> File Server</button>
            <button id="addisp"><i class="fa-solid fa-signal"></i> ISP</button>
            <button id="addwifirouter"><i class="fa-solid fa-signal"></i> Wifi Router</button>
            <button id="addrepeater"><i class="fa-solid fa-repeat"></i> Repeater</button>
            <button id="addprinter"><i class="fa-solid fa-print"></i> Printer</button>
            <button id="addphone"><i class="fa-solid fa-mobile-button"></i> Phone</button>
            <button id="addmodem"><i class="fas fa-wifi"></i> Modem</button>
            <button id="sendPacketBtn"><i class="fa-solid fa-envelope"></i> Send Packet</button>
            <button id="addConnectionBtn"> <i class="fa-solid fa-ethernet"></i> Connect Straight</button>
            <button id="addDashedConnectionBtn"><i class="fa-solid fa-ethernet"></i> Connect Cross-over</button>
            <button id="addCoaxial"><i class="fa-solid fa-ethernet"></i> Connect Wireless</button>
            <button id="addwire"><i class="fa-solid fa-ethernet"></i> Connect Coaxial</button>
            <button id="cliButton"> <i class="fa-solid fa-terminal"></i> CLI</button>
            <button id="addip"><i class="fa-solid fa-globe"></i> Set Address</button>
            <button id="addgateway"><i class="fa-solid fa-globe"></i> Gateway</button>
            <button id="sshButton"><i class="fa-solid fa-globe"></i> SSH</button>
            <button id="addfirewall"> <i class="fa-solid fa-shield"></i> Firewall</button>
            <button id="closePortButton"> <i class="fa-solid fa-shield"></i> Close Port</button>
            <button id="openPortButton"> <i class="fa-solid fa-shield"></i> Open Port</button>
            <button id="addencript"> <i class="fa-solid fa-file-contract"></i> Encrypte</button>
            <button id="addwpa"> <i class="fa-solid fa-lock"></i> Wpa Psk</button>
            <button id="addCircleBtn">Circle Area</button>
            <button id="removeDeviceBtn">Remove Selected Device</button>
          
            <button id="hapusGarisBtn">Hapus Semua Garis</button>
        </div>
...
function getIpAddress(device) {
    ...
    function addDevice(deviceType) {
        ...
        newDevice.innerHTML = `<img src="{{ asset('images/devices/' . '${deviceType}.png') }}" style="width: 115px; height: 115px;" /> ${deviceName}`;
